...
public class StatistiqueReclamationForm extends Form {
    ...
    private double nbr_reclamation = 29;
        ...
        Form current;
        Form form;
        public StatistiqueReclamationForm(Resources res)  {
        ...
        bindButtonSelection(profile, arrow);
                profile.addActionListener((e)->{
                  new StatistiqueReclamationForm(res).show();
   ...
   private void addButton(Image img,String title) {
       ...
       image.addActionListener(e -> {
           try{
           new AjouterReclamationForm(Resources.getGlobalResources()).show();
           }catch(Exception exx) {
