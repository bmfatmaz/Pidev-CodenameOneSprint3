    ...
    public NewContactForm() {
        ...
        addButton.addActionListener(evt -> {
            ...
            if (receiverUsername.isEmpty() || message.isEmpty()) {
                ...
                request.setUrl("http://localhost:8000/message/newContact-from-codename-one?receiver_username="+ receiverUsername + "&message=" + message+"&userid="+CurrentUser.getInstance().getId());
